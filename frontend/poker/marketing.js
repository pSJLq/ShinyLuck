...
(function () {
  ...
  var HEADER = '' +
    '<header class="mkt-header"><div class="container">' +
      '<a href="index.html" class="mkt-logo">' + logo(19) + '</a>' +
      '<nav class="mkt-nav">' +
        '<a href="index.html#how">How it works</a>' +
        '<a href="index.html#fair">Provably fair</a>' +
        '<a href="lobby.html">Tournaments</a>' +
        '<a href="provably-fair.html">Docs</a>' +
      '</nav>' +
      '<div class="spacer"></div>' +
      '<div class="mkt-switcher">' +
        '<a class="casino" href="https://shiny-luck.vercel.app/"><span class="dot"></span>ShinyLuck</a>' +
        '<a class="on" href="index.html"><span class="dot"></span>Poker</a>' +
      '</div>' +
      '<a class="btn primary" href="table.html?t=0">Connect Wallet &amp; Play</a>' +
    '</div></header>';
  ...
  var FOOTER = '' +
    '<footer class="mkt-footer"><div class="container">' +
      '<div class="ftop">' +
        '<div class="fbrand">' +
          '<a href="index.html" style="text-decoration:none">' + logo(18) + '</a>' +
        ...
        '<div class="fcol"><div class="fh">Play</div>' +
          '<a href="lobby.html">Cash games</a><a href="lobby.html">Tournaments</a>' +
          '<a href="lobby.html">Sit &amp; Go</a><a href="lobby.html">Clubs</a>' +
          '<a href="lobby.html">Cashier</a></div>' +
        '<div class="fcol"><div class="fh">Trust</div>' +
          '<a href="provably-fair.html">Provably fair</a><a href="provably-fair.html">zkShuffle</a>' +
        ...
        '<div class="fcol"><div class="fh">Company</div>' +
          ...
          '<a href="#">Powered by Somnia ↗</a><a href="https://shiny-luck.vercel.app/">ShinyLuck Casino ↗</a></div>' +
      '</div>' +
      '<div class="fchain">' +
  ...
  function slimFooter() {
    return '<div class="appfooter">' + logo(12) +
      ...
      '<a href="provably-fair.html">Provably Fair</a>' +
      '<a href="responsible.html">Responsible Gaming</a>' +
      '<a href="terms.html">Terms</a>' +
      '<span class="spacer"></span>' +
      '<span class="ci"><span class="dot"></span>Somnia Testnet · v1.4.2</span>' +
