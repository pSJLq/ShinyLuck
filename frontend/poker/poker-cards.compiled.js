/* AUTO-GENERATED from poker-cards.jsx by scripts/build-poker-jsx.js — do NOT edit. */
...
function Card({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rank"
  }, RANK_LABEL[rank] || rank), /*#__PURE__*/React.createElement("span", {
...
function BraceLogo({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    viewBox: "0 0 130 390.309",
    fill: "none",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("path", {
    d: "M 0 180.699 L 18.07 180.699 C 23.19 180.699 27.707 179.644 31.622 177.536 C 35.537 175.127 38.7 172.115 41.109 168.501 C 43.819 164.586 45.777 160.37 46.982 155.852 C 48.487 151.034 49.24 146.215 49.24 141.397 L 49.24 68.665 C 49.24 57.522 50.294 47.735 52.403 39.302 C 54.812 30.869 58.727 23.792 64.148 18.07 C 69.569 12.047 76.797 7.529 85.832 4.517 C 95.168 1.506 106.763 0 120.616 0 L 157.208 0 L 157.208 29.364 L 118.809 29.364 C 106.16 29.364 97.125 32.225 91.704 37.947 C 86.585 43.669 84.025 54.059 84.025 69.117 L 84.025 131.458 C 84.025 151.636 81.013 166.544 74.99 176.181 C 68.967 185.517 62.04 191.842 54.21 195.154 C 62.04 198.768 68.967 205.545 74.99 215.483 C 81.013 225.421 84.025 239.877 84.025 258.851 L 84.025 321.192 C 84.025 336.25 86.735 346.64 92.156 352.362 C 97.577 358.084 106.612 360.945 119.261 360.945 L 157.208 360.945 L 157.208 390.309 L 120.616 390.309 C 106.763 390.309 95.168 388.803 85.832 385.791 C 76.797 382.78 69.569 378.262 64.148 372.239 C 58.727 366.517 54.812 359.439 52.403 351.007 C 50.294 342.574 49.24 332.786 49.24 321.643 L 49.24 248.912 C 49.24 244.395 48.487 239.877 46.982 235.36 C 45.777 230.541 43.819 226.325 41.109 222.711 C 38.7 218.796 35.537 215.634 31.622 213.224 C 28.008 210.815 23.641 209.61 18.522 209.61 L 0 209.61 L 0 180.699 Z",
    fill: "currentColor"
  }))), withS && /*#__PURE__*/React.createElement("span", {
    className: "glyph"
...
function AvatarIcon({
  ...
  if (img) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        background: `url("${img}") center/cover no-repeat, #15151c`,
        ...box,
        ...style
      }
    });
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "avatar deco",
    style: {
      background: `linear-gradient(${c.rot}deg, ${c.a}, ${c.b})`,
      ...box,
      ...style
    }
  }, /*#__PURE__*/React.createElement(SparkMark, {
    style: {
      position: "absolute",
      inset: "10%",
      color: "rgba(255,246,221,.30)",
      transform: `rotate(${c.rot % 50 - 25}deg)`
    }
  ...
  return new Promise((resolve, reject) => {
    ...
    im.onload = () => {
      ...
      for (let q = 0.85; q >= 0.3; q -= 0.1) {
        ...
        if (bytes.length <= maxBytes) return resolve({
          bytes,
          dataUri: uri
        });
      }
...
const SP_I18N_RU = {
  ...
  "wins": "выигрывает",
  "paid out on-chain": "- выплата он-чейн",
  "pot settled on-chain": "банк рассчитан он-чейн",
  "Winning hand": "Победная рука",
  "Settling pot on-chain…": "Банк рассчитывается он-чейн…",
  "Action sent": "Действие отправлено",
  "Confirming on-chain…": "Подтверждаем он-чейн…",
  "Dealer button": "Баттон (дилер) · раздача идёт от него",
  "Small blind": "Малый блайнд",
  "Big blind": "Большой блайнд",
  ...
  "left": "в игре",
  "finished": "завершён",
  "level up next hand": "уровень со след. руки",
  "Table": "Стол",
  "Switch to this table": "Перейти к этому столу",
  ...
  "Send": "Отпр.",
  "table chat · dealer feed": "чат стола · лента дилера",
  "hand history · on-chain": "история рук · он-чейн",
  "private player notes": "приватные заметки",
  "chat": "чат",
  "hands": "руки",
  "notes": "заметки",
  ...
  "table settings": "настройки стола",
  "Table theme": "Тема стола",
  "Sound effects": "Звуки",
  "4-color deck": "4-цветная колода",
  "Turbo animations": "Турбо-анимации",
  ...
  "Language": "Язык",
  "Close": "Закрыть",
  "Sit at seat": "Сесть на место",
  "Buy-in": "Бай-ин",
  "Cancel": "Отмена",
  "Take seat": "Сесть",
  "Leave table": "Покинуть стол",
  "Back to tournament": "К турниру",
  "Settings": "Настройки",
  "Sit out": "Сит-аут",
...
window.__SPLANG = function () {
  try {
    return localStorage.getItem("sl-lang") || localStorage.getItem("sp_lang") || "en";
  } catch (e) {
    return "en";
  }
}();
...
if (typeof document !== "undefined") {
  document.addEventListener("shinyluck:lang", e => {
    ...
    window.__SPLANG = l;
    try {
      window.dispatchEvent(new CustomEvent("sp-lang-changed", {
        detail: {
          lang: l
        }
      }));
